...
<body>
            ...
            <div class="w-full max-w-xl relative flex">
                ...
                <input type="text" name="search" id="search"
                    ...
                    <button class="bg-primary border border-primary text-white px-8 rounded-r-md hover:bg-transparent hover:text-primary transition hidden md:flex"
                            style="display: flex; justify-content: center; font-size: 30px;">
                        cari
                    </button>
    ...
    <div class="container pb-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="bg-white shadow rounded overflow-hidden group">
                <div class="relative">
                    <img src="{{ asset('/rumah/images/products/product1.jpg')}}" alt="product 1" class="w-full">
            ...
            <div class="bg-white shadow rounded overflow-hidden group">
                <div class="relative">
                    <img src="{{ asset('/rumah/images/products/product4.jpg')}}" alt="product 1" class="w-full">
                    <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center 
                    justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                        <a href="#"
                            class="text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-800 transition"
            ...
            <div class="bg-white shadow rounded overflow-hidden group">
                <div class="relative">
                    <img src="{{ asset('/rumah/images/products/product2.jpg')}}" alt="product 1" class="w-full">
                    <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center 
                    justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                        <a href="#"
                            class="text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-800 transition"
            ...
            <div class="bg-white shadow rounded overflow-hidden group">
                ...
                <div class="relative">
                    <img src="{{ asset('/rumah/images/products/product3.jpg')}}" alt="product 1" class="w-full">
                    <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center 
                    justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                        <a href="#"
                            class="text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-800 transition"
    ...
    <div class="container pb-16">
        <a href="#">
            <img src="{{ asset('/rumah/images/offer.jpg')}}" alt="ads" class="w-full">
        </a>
    </div>
    <!-- ./ads -->
    ...
    <footer class="bg-white pt-16 pb-12 border-t border-gray-100">
        <div class="container grid grid-cols-1 ">
            <div class="col-span-1 space-y-4">
                <img src="{{ asset('/rumah/images/logo.svg')}}" alt="logo" class="w-30">
                <div class="mr-2">
    ...
    <div class="bg-gray-800 py-4">
        <div class="container flex items-center justify-between">
            ...
            <div>
                <img src="{{ asset('/rumah/images/methods.png')}}" alt="methods" class="h-5">
            </div>
        </div>
    </div>
    <!-- ./copyright -->
